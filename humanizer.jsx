...
async function callClaudeAPI(apiKey,model,text){
  const prompt="Rewrite the following text in natural, varied human "+
    "English to lower its AI-detection score on tools like GPTZero. "+
    "Specifically:\n\n"+
    "- Convert passive / stative voice (\"X is identified\") to active "+
    "voice (\"clinicians find X\") wherever it reads natural.\n"+
    "- Vary sentence length dramatically. Mix short fragments with "+
    "longer sentences. Avoid uniform rhythm.\n"+
    "- Use contractions (it is -> it's, do not -> don't, cannot -> "+
    "can't).\n"+
    "- Strip formulaic transitions (Moreover, Furthermore, In "+
    "conclusion, It is important to note that, ...).\n"+
    "- Avoid stacking hedging adverbs (frequently, commonly, often, "+
    "typically, similarly). Pick at most one per sentence.\n"+
    "- Replace em-dashes with commas or periods.\n"+
    "- Add concrete specifics (numbers, named conditions, real "+
    "examples) where the meaning allows.\n"+
    "- Keep ALL factual content, technical terms (medical / legal / "+
    "scientific jargon), and the original meaning intact.\n"+
    "- Match the original register (formal stays formal, casual "+
    "casual).\n\n"+
